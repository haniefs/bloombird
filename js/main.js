...
function startGame()
{
   ...
   loopPipeloop = setInterval(updatePipes, 500);
...
function gameloop() {
   ...
   var nextpipedown = nextpipe.children(".pipe_lower");

   var pipebottom = pipetop + 420- nextpipedown.height();
...
function updatePipes()
{
   ...
   var bottomheight = result;//(420 - pipeheight) - topheight;
   topheight = 0;
