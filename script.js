    ...
    if (company == 'null') {
      ...
      $.ajax({
        ...
        success: function(res) {
          ...
          '<div id="companyName" style="width: 600px; height: 150px; position: relative;  left: 50px; float: left;"> <h3 style="margin-top: 45px; font-size: 48px;">Company Name</h3> </div> <div id="companyYear" style="width: 750px; height: 150px; position: relative;  right: 0; float: right;"> <h3 style="margin-top: 56px; font-size: 38px;">Stock price 350$ for Jan 2005</h3> </div>' +
